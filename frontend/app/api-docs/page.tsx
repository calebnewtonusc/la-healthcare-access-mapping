          ...
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-6 shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-lg font-bold text-slate-900">API Status: Live</h3>
                </div>
                <p className="text-sm text-slate-600">
                  Base URL: <code className="bg-slate-100 px-2 py-1 rounded text-xs font-mono">{API_BASE_URL}</code>
                </p>
              </div>
              <a
            ...
            <div className="mt-4 grid grid-cols-3 gap-4">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-center">
                ...
                <div className="text-xs text-slate-700">Endpoints</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div key={idx} className="relative group">
              ...
              <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-6 shadow-lg">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <code className="text-slate-900 font-mono text-sm">{endpoint.path}</code>
                      {endpoint.liveData && (
                ...
                <div className="mb-4 bg-slate-50 border border-slate-200 rounded-lg p-3">
                  <p className="text-xs text-slate-600 mb-1 font-semibold">Full URL:</p>
                ...
                <div className="mt-3 bg-slate-50 border border-slate-200 rounded-lg p-3">
                  <p className="text-xs text-slate-600 mb-1 font-semibold">cURL Command:</p>
        ...
        <div className="mt-8 relative group">
          ...
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-slate-900 mb-3 text-sm">API Framework</h4>
              ...
              <div>
                <h4 className="font-semibold text-slate-900 mb-3 text-sm">Response Features</h4>
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex items-center gap-2">
            ...
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-slate-900 text-sm mb-1">Data Freshness</p>
