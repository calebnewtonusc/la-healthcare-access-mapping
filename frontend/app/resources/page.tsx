    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="relative mb-6 group">
          ...
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-8 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Interactive Official Maps</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <a href="https://apps.gis.lacounty.gov/static/DPH/community-profiles/" target="_blank" rel="noopener noreferrer"
                ...
                <div className="relative bg-white/70 backdrop-blur-sm border border-blue-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <Building2 className="w-6 h-6 text-blue-600" />
                    <ExternalLink className="w-4 h-4 text-slate-400" />
                  </div>
                  <h3 className="font-bold text-slate-900 mb-2">LA County Community Health Profiles</h3>
                  <p className="text-sm text-slate-700 mb-2">Interactive maps showing healthcare indicators across LA County communities</p>
              ...
              <a href="https://ph-lacounty.hub.arcgis.com/pages/chp" target="_blank" rel="noopener noreferrer"
                ...
                <div className="relative bg-white/70 backdrop-blur-sm border border-purple-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <Database className="w-6 h-6 text-purple-600" />
                    <ExternalLink className="w-4 h-4 text-slate-400" />
                  </div>
                  <h3 className="font-bold text-slate-900 mb-2">LA County Public Health Data Hub</h3>
                  <p className="text-sm text-slate-700 mb-2">Centralized portal for LA County Department of Public Health maps and datasets</p>
              ...
              <a href="https://planning.lacity.gov/interactive-health-atlas/index/index.html" target="_blank" rel="noopener noreferrer"
                ...
                <div className="relative bg-white/70 backdrop-blur-sm border border-green-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <Layers className="w-6 h-6 text-green-600" />
                    <ExternalLink className="w-4 h-4 text-slate-400" />
                  </div>
                  <h3 className="font-bold text-slate-900 mb-2">LA City Interactive Health Atlas</h3>
                  <p className="text-sm text-slate-700 mb-2">City of LA planning department's comprehensive health mapping tool</p>
        ...
        <div className="relative mb-6 group">
          ...
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-8 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Federal Shortage Area Designation Tools</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="bg-red-50/80 backdrop-blur-sm rounded-lg p-5 border border-red-200">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 mb-1">HRSA HPSA Find Tool</h3>
                    <p className="text-xs text-slate-700 mb-2">Search for designated health professional shortage areas by address or region</p>
                ...
                <div className="mt-3 p-2 bg-white/60 rounded text-xs text-slate-600">
              ...
              <div className="bg-orange-50/80 backdrop-blur-sm rounded-lg p-5 border border-orange-200">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 mb-1">HRSA MUA/P Find Tool</h3>
                    <p className="text-xs text-slate-700 mb-2">Locate medically underserved areas and populations across the United States</p>
              ...
              <div className="bg-purple-50/80 backdrop-blur-sm rounded-lg p-5 border border-purple-200">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 mb-1">Find a Health Center (FQHC Locator)</h3>
                    <p className="text-xs text-slate-700 mb-2">Locate federally qualified health centers providing care regardless of insurance status</p>
              ...
              <div className="bg-blue-50/80 backdrop-blur-sm rounded-lg p-5 border border-blue-200">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 mb-1">LA County MUA/P Map</h3>
                    <p className="text-xs text-slate-700 mb-2">Interactive map of officially designated medically underserved areas in LA County</p>
        ...
        <div className="relative mb-6 group">
          ...
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-8 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Facility & Service Locators</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-green-50/80 backdrop-blur-sm rounded-lg p-4 border border-green-200">
                <h3 className="font-semibold text-slate-900 mb-2 text-sm">LA County DHS Facilities</h3>
                <p className="text-xs text-slate-700 mb-3">Search for LA County Department of Health Services clinics and hospitals</p>
              ...
              <div className="bg-teal-50/80 backdrop-blur-sm rounded-lg p-4 border border-teal-200">
                <h3 className="font-semibold text-slate-900 mb-2 text-sm">My Health LA Clinics</h3>
                <p className="text-xs text-slate-700 mb-3">Community clinics participating in LA County's My Health LA program</p>
              ...
              <div className="bg-blue-50/80 backdrop-blur-sm rounded-lg p-4 border border-blue-200">
                <h3 className="font-semibold text-slate-900 mb-2 text-sm">CA FQHC Directory</h3>
                <p className="text-xs text-slate-700 mb-3">State-maintained list of all federally qualified health centers in California</p>
        ...
        <div className="relative mb-6 group">
          ...
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-8 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Health Equity & Social Determinants</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-amber-50/80 backdrop-blur-sm rounded-lg p-5 border border-amber-200">
                <h3 className="font-bold text-slate-900 mb-2">Healthy Places Index</h3>
              ...
              <div className="bg-yellow-50/80 backdrop-blur-sm rounded-lg p-5 border border-yellow-200">
                <h3 className="font-bold text-slate-900 mb-2">My Neighborhood Data</h3>
                <p className="text-sm text-slate-700 mb-3">
        ...
        <div className="relative mb-6 group">
          ...
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-8 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Downloadable Datasets</h2>
            </div>
            ...
            <div className="space-y-3">
              <div className="bg-slate-50/80 backdrop-blur-sm rounded-lg p-4 border border-slate-200">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-900 mb-1 text-sm">LA County Healthcare Facilities (CDPH)</h3>
                    <p className="text-xs text-slate-700 mb-2">Licensed healthcare facilities from California Department of Public Health</p>
              ...
              <div className="bg-slate-50/80 backdrop-blur-sm rounded-lg p-4 border border-slate-200">
                <div className="flex items-start gap-3">
                  <Layers className="w-5 h-5 text-slate-600 mt-0.5" />
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-900 mb-1 text-sm">CA Medical Service Study Areas</h3>
                    <p className="text-xs text-slate-700 mb-2">Standardized geographic boundaries for healthcare planning in California</p>
              ...
              <div className="bg-slate-50/80 backdrop-blur-sm rounded-lg p-4 border border-slate-200">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-900 mb-1 text-sm">HPSA Designations (California)</h3>
                    <p className="text-xs text-slate-700 mb-2">Geospatial data for all Health Professional Shortage Areas in CA</p>
        ...
        <div className="relative mb-6 group">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl blur-sm opacity-30 group-hover:opacity-50 transition-opacity"></div>
          <div className="relative bg-white/80 backdrop-blur-md border border-white/60 rounded-2xl p-8 shadow-lg">
            <h2 className="text-xl font-bold text-slate-900 mb-4">How to Use These Resources</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <h3 className="font-semibold text-slate-900 text-sm">For Policymakers & Planners</h3>
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-slate-900 text-sm">For Researchers & Analysts</h3>
                <ul className="text-xs text-slate-700 space-y-2">
                  <li className="flex items-start gap-2">
