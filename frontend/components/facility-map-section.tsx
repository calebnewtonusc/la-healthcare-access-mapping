    ...
    <div className="relative group">
      ...
      <div className="relative bg-white/70 backdrop-blur-md border border-white/50 rounded-2xl p-6 shadow-md">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-slate-700 mt-3 text-center flex items-center justify-center gap-2">
          ...
          <div>
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto pr-2">
              {facilities.slice(0, 5).map((facility, index) => {
                ...
                return (
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-slate-100 to-slate-200 rounded-lg blur opacity-20 group-hover/facility:opacity-40 transition-opacity"></div>
                    <div className="relative bg-white/60 backdrop-blur-sm border border-white/40 rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="mt-4 text-center">
              <a
                ...
                className="inline-flex items-center gap-2 text-slate-700 hover:text-blue-600 text-sm font-medium transition-colors group"
              >
